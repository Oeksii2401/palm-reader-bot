TEXTS = {
    "uk": {
        ...
        "name_ask":        "🔤 Введіть ім'я для аналізу:\n\nПриклад: Олексій",
        "name_analyzing":  "🔤 Розкриваю таємницю імені...",
        "name_upgrade_std":  "✨ Аналіз імені з нумерологією та характером доступний від підписки <b>Стандарт</b>.",
        "name_upgrade_prem": "🔮 Повний містичний аналіз імені доступний для підписки <b>Преміум</b>.",
        ...
        "notify_ask_birth_time": "🕐 Введіть ЧАС народження (для точного розрахунку):\n\nПриклад: 14:30\n\nЯкщо не знаєте точний час — напишіть 12:00",
        "notify_ask_city":       "📍 Введіть МІСТО народження (для точного розрахунку):\n\nПриклад: Київ",
        "notify_ask_time":   "⏰ О котрій годині надсилати гороскоп?\n\nПриклад: 09:00\n(час київський, формат ГГ:ХХ)",
        "notify_saved":      "✅ Готово! Щоденний персональний гороскоп приходитиме о {time} 🌟\n\nЗмінити налаштування: /notify",
    ...
    "ru": {
        ...
        "name_ask":        "🔤 Введите имя для анализа:\n\nПример: Алексей",
        "name_analyzing":  "🔤 Раскрываю тайну имени...",
        "name_upgrade_std":  "✨ Анализ имени с нумерологией и характером доступен от подписки <b>Стандарт</b>.",
        "name_upgrade_prem": "🔮 Полный мистический анализ имени доступен для подписки <b>Премиум</b>.",
        ...
        "notify_ask_birth_time": "🕐 Введите ВРЕМЯ рождения (для точного расчёта):\n\nПример: 14:30\n\nЕсли не знаете точное время — напишите 12:00",
        "notify_ask_city":       "📍 Введите ГОРОД рождения (для точного расчёта):\n\nПример: Киев",
        "notify_ask_time":   "⏰ В какое время присылать гороскоп?\n\nПример: 09:00\n(время киевское, формат ЧЧ:ММ)",
        "notify_saved":      "✅ Готово! Ежедневный персональный гороскоп будет приходить в {time} 🌟\n\nИзменить настройки: /notify",
    ...
    "en": {
        ...
        "name_ask":        "🔤 Enter a name to analyze:\n\nExample: Alexander",
        "name_analyzing":  "🔤 Revealing the mystery of the name...",
        "name_upgrade_std":  "✨ Name analysis with numerology and character is available from <b>Standard</b> subscription.",
        "name_upgrade_prem": "🔮 Full mystical name analysis is available for <b>Premium</b> subscription.",
        ...
        "notify_ask_birth_time": "🕐 Enter your birth TIME (for accurate calculation):\n\nExample: 14:30\n\nIf you don't know the exact time — write 12:00",
        "notify_ask_city":       "📍 Enter your birth CITY (for accurate calculation):\n\nExample: London",
        "notify_ask_time":   "⏰ What time should I send your horoscope?\n\nExample: 09:00\n(Kyiv time, format HH:MM)",
        "notify_saved":      "✅ Done! Daily personal horoscope will arrive at {time} 🌟\n\nChange settings: /notify",
    ...
    "de": {
        ...
        "menu_name":       "🔤 Bedeutung des Namens",
        "back":            "↩️ Hauptmenü",
        "exit_btn":        "🚪 Beenden",
        ...
        "name_ask":        "🔤 Geben Sie einen Namen zur Analyse ein:\n\nBeispiel: Alexander",
        "name_analyzing":  "🔤 Enthülle das Geheimnis des Namens...",
        "name_upgrade_std":  "✨ Namensanalyse mit Numerologie und Charakter ist ab <b>Standard</b>-Abo verfügbar.",
        "name_upgrade_prem": "🔮 Vollständige mystische Namensanalyse ist für <b>Premium</b>-Abo verfügbar.",
        ...
        "notify_ask_birth_time": "🕐 Geben Sie Ihre Geburtszeit ein (für genaue Berechnung):\n\nBeispiel: 14:30\n\nWenn unbekannt — schreiben Sie 12:00",
        "notify_ask_city":       "📍 Geben Sie Ihre Geburtsstadt ein (für genaue Berechnung):\n\nBeispiel: Berlin",
        "notify_ask_time":   "⏰ Um wie viel Uhr soll ich das Horoskop senden?\n\nBeispiel: 09:00\n(Kyiver Zeit, Format HH:MM)",
        "notify_saved":      "✅ Fertig! Das tägliche persönliche Horoskop kommt um {time} 🌟\n\nEinstellungen ändern: /notify",
